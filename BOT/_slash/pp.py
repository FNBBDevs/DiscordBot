...
class pp:
    def __init__(self, tree, guild):
        @tree.command(name='pp', description='Slimey and Gooey', guild=discord.Object(id=guild))
        async def pp(interaction: discord.Interaction, user: discord.User = None):
            ...
            embed.set_author(name='Weenus Peenus.com', url='https://nulzo.github.io/', icon_url=random.choice(_ICONS))
