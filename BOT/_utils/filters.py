audio_filters = {
    ...
    "slowwwwww": "highpass=f=10, lowpass=f=250, aresample=48000 ,bass=g=7:f=110:w=0.6, alimiter=1, compand=attacks=0:points=-80/-169|-54/-80|-49.5/-64.6|-41.1/-41.1|-25.8/-15|-10.8/-4.5|0/0|20/8.3",
